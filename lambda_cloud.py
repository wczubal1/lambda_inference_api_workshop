...
class LambdaCloudClient:
    ...
    def create_instance(self, instance_data: Dict) -> Dict:
        ...
        return self._make_request("POST", "instances", json=instance_data)

    def terminate_instance(self, instance_id: str) -> Dict:
        """Terminate an instance."""
        return self._make_request("POST", f"instances/{instance_id}/terminate")
...
LAMBDA_CLOUD_FUNCTIONS = [
    {
        "name": "list_instances",
        "description": "List all Lambda Cloud instances",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "ssh_key_names": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "List of SSH key names to use"
                }
            },
            "required": ["name", "instance_type", "region", "ssh_key_names"]
        }
    },
    {
        "name": "terminate_instance",
        "description": "Terminate a Lambda Cloud instance",
        "parameters": {
            "type": "object",
            "properties": {
                "instance_id": {
    ...
    },
    {
        ...
        "description": "List available Lambda Cloud instance types",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
    ...
    {
        "name": "get_instance",
        "description": "Get details of a specific Lambda Cloud instance",
        "parameters": {
            "type": "object",
            "properties": {
                "instance_id": {
